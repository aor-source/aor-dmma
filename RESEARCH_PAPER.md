...
## 2. Theoretical Framework: DMMA

### 2.1 Dynamical Model of Musical Affect

The core theoretical contribution of this work is the **Dynamical Model of Musical Affect (DMMA)**, a novel computational framework that models a song's emotional arc as a trajectory Φ(t) through a high-dimensional emotional phase space H_MAIF.

**Foundational Principle (Axiom of Resonant Synthesis):**
> *Valence is not a feature to be classified—it's an emergent property arising from the friction between interacting data streams. Static classification (averaging features into labels) is the fundamental betrayal that creates the semantic gap rather than bridging it.*

Unlike traditional approaches that reduce songs to static feature vectors, DMMA treats each song as a **continuous path** through emotional space. The trajectory is governed by a phenomenological equation of motion:

```
dx/dt = F(x, t)
```

Where F(x,t) represents the "force" of musical, harmonic, and narrative intent acting on the listener's internal state. Each dimension corresponds to a time-varying feature from the MAIF specification (MFCCs, Tonnetz, spectral features, etc.).

### 2.2 Structural Components

The trajectory through H_MAIF reveals two key structural components:

**Stable Attractor Basins**
- Regions where the trajectory loops tightly
- Characterized by: strong periodicity, low variance, high density
- Musical correlates: choruses, grooves, core emotional states

**High-Energy Transitions**
- Paths between basins
- Characterized by: high variance, high curvature, low density
- Musical correlates: bridges, builds, drops, breakdowns

### 2.3 Emergent Metrics

From DMMA, two metrics emerge naturally:

**TVT (Topological Valence Trajectory)**
UMAP projection of the trajectory revealing the "shape of feeling":
- Loops indicate attractor basins (emotional anchors)
- Voids represent inaccessible affective states
- Threads are transition paths between states

**SDS (Semantic Dissonance Score)**
Measures the tension between lyrical sentiment and audio arousal:
- Functions as a "Semantic Volatility Score" rather than simple irony detection
- High SDS indicates subversive content where words and music convey opposite affects
- Characteristic of sophisticated artistic expression (saying one thing, meaning another)

### 2.4 Why DMMA Matters for Bias Detection

The DMMA framework reveals biases that static analysis cannot capture:

1. **Trajectory Complexity**: Human artists create more complex paths through emotional space (higher TVT)
2. **Semantic Tension**: Authentic hip-hop maintains productive friction between channels (higher SDS)
3. **Attractor Diversity**: Human content exhibits more varied emotional basins

AI-generated content, by contrast, tends toward:
- Smoother, less varied trajectories
- Lower semantic tension (words match music too directly)
- Fewer attractor states (emotional monotony)

These patterns are invisible to static feature analysis but emerge clearly in the dynamical framework.

---

## 3. Background

### 3.1 AAVE Linguistics
...
### 5.1 Discovery 1: ASR Erasure Bias
...
### 5.2 Discovery 2: AI Cultural Intelligence Gap
...
### 6.2 Cultural Intelligence Deficit
